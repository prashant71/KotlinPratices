class Vehicle constructor(val name: String,val type:String,capacity:Int=2) { // this is treat as primary constructor
    ...
    var capacity = capacity // property created when we define as var and val still then it is like parameter not able to accessible outside
